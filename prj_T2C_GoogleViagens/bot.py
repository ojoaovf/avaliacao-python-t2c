...
Please refer to the documentation Françafor more information at https://documentation.botcity.dev/
"""
...
from prj_T2C_GoogleViagens.classes.TratarExcel import TratarExcel
...
class Bot(WebBot):
    ...
    def action(self, execution=None):
        ...
        var_clssTratarExcel = TratarExcel(arg_clssMaestro=var_clssMaestro, arg_dictConfig=var_dictConfig)
        ...
        while(var_tplQueueItem is not None):
            for var_intTentativa in range(var_dictConfig["MaxRetryNumber"]):
                try:
                    ...
                    var_listDadosViagem = var_clssProcess.execute(arg_tplQueueItem=var_tplQueueItem)
        ...
        try:
            var_clssTratarExcel.inserir_e_tratar_excel(arg_listDadosViagem = var_listDadosViagem,
                                                       arg_strCaminhoPlanilha='viagens.xlsx')
